...
export default () => (
  ...
  <AccordionList className="max-w-3x1 mx-100 mx-100 bg-gradient-to-b from-Az1 via-grey text-white">
    ...
    <Accordion>
      <AccordionHeader className="font-regular avant-garde-regular bg-gradient-to-b from-Az4 via-Az4 to-grey text-white" >¿Qué es una mesa de ayuda y por qué mi empresa necesita una?</AccordionHeader>
      <AccordionBody className="font-bold avant-garde-bold bg-gradient-to-b from-Az4 via-Az4 to-Az4 text-white">
    ...
    <Accordion>
      <AccordionHeader className="font-regular avant-garde-regular bg-gradient-to-b from-Az4 via-Az4 to-grey text-white">¿Cómo puedo registrarme en la plataforma de gestión de tickets?</AccordionHeader>
      <AccordionBody className="font-bold avant-garde-bold bg-gradient-to-b from-Az4 via-Az4 to-Az4 text-white">
    ...
    <Accordion>
      <AccordionHeader className="font-regular avant-garde-regular bg-gradient-to-b from-Az4 via-Az4 to-grey text-white">¿Qué beneficios obtendré al utilizar su plataforma?</AccordionHeader>
      <AccordionBody className="font-bold avant-garde-bold bg-gradient-to-b from-Az4 via-Az4 to-Az4 text-white">
    ...
    <Accordion>
        <AccordionHeader className="font-regular avant-garde-regular bg-gradient-to-b from-Az4 via-Az4 to-grey text-white">¿Cómo puedo crear y seguir un ticket de servicio?</AccordionHeader>
      <AccordionBody className="font-bold avant-garde-bold bg-gradient-to-b from-Az4 via-Az4 to-Az4 text-white">
