...
const Description = () => {
  ...
  return (
    <div className="mt-40 mb-40">
      <h2 className="leading-loose font-regular text-2xl  bg-black bg-opacity-40 text-white p-2 rounded-lg shadow-md w-full h-full flex items-center justify-center text-center avant-garde-regular">
