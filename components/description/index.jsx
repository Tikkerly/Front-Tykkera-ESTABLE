        ...
        <div className="w-100% h-100% mt-20 p-20 bg-white flex items-center justify-center content-center bg-opacity-50 rounded-lg ">
          <div className=" ">
            ...
            <h2 className="leading-loose bg-az1 w-1/2 font-regular text-2xl text-gray flex avant-garde-regular   description">
              Facilitamos la gestión de tickets de mesa de ayuda para empresas
              de reparación y mantenimiento de equipos tecnológicos.
            </h2>
            <Link href='/registrarse'>
              <button className="avant-garde-bold font-bold bg-Az5 text-gray px-6 py-3 rounded-full transition duration-300 hover:shadow-md hover:underline w-40 flex justify-center">
                Empezar
              </button>
            </Link>
          </div>
